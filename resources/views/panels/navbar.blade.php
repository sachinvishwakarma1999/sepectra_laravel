          ...
          <li class="dropdown dropdown-user nav-item">
            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
              <div class="user-nav d-sm-flex d-none">
                ...
                <span class="user-status text-muted"> {{ Auth::user()->status == 1 ? 'Available' : 'Not Available' }} </span>
              </div>
            ...
            <div class="dropdown-menu dropdown-menu-right pb-0">
              ...
              <a class="dropdown-item" href="{{ route('edituser',Auth::user()->id) }}">
                <i class="bx bx-user mr-50"></i> Edit Profile
              </a>
              ...
              <a class="dropdown-item" href="{{route('change-password')}}"><i class="bx bx-power-off mr-50"></i> Change Password</a>
