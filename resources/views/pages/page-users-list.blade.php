      ...
      <div class="card-content">
        <div class="card-body">
          ...
          <div class="text-right">
            <a class="btn btn-primary text-white" data-toggle="modal" data-target="#userCreateModal"> <i class="fa fa-plus"></i> Create User</a><br><br>
          </div>
              ...
              <tbody>
                  @foreach($users as $key=>$user)
                    <tr>
                      ...
                      <td>
                          <a  onclick="return confirm('Are you sure, you want to delete it?')" href="{{ route('deleteuser',$user->id) }}" class="text-danger"><i class="bx bx-trash"></i></a>
                          <a href="{{ route('edituser',$user->id) }}"><i class="bx bx-edit-alt"></i></a>
                      </td>
                    </tr>
                  @endforeach
              </tbody>
