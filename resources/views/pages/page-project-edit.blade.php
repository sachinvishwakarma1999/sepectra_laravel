      ...
      <div class="card-body">
        <ul class="nav nav-tabs mb-2" role="tablist">
          <li class="nav-item">
              <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab"
                  ...
                  <i class="bx bx-edit mr-25"></i><span class="d-none d-sm-block">Edit Project Type</span>
              </a>
          </li>
        </ul>
        ...
        <div class="tab-content">
          <div class="tab-pane active fade show" id="account" aria-labelledby="account-tab" role="tabpanel">
            ...
            <form novalidate method="post" action="{{ route('updateproject') }}">
                @csrf
                        ...
                        <div class="form-group">
                            <div class="controls">
                                ...
                                <textarea style="height:200px;" name="description" class="form-control" placeholder="Name" required
                                    data-validation-required-message="This title field is required">{{ $project->description }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                          <div class="controls">
